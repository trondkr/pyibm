...
"""Call this routine using:
mortality, didStarve = predation.FishPredAndStarvation(grdSTATION,deltaH,FishDens,
...
def FishPredAndStarvation(grdSTATION,dh,FishDens,Larval_m,Larval_wgt,attCoeff,Eb,seconds,ing,stomachFullness):
    ...
    Starved = aliveOrDead(Larval_wgt, Larval_m,ing,stomachFullness)
